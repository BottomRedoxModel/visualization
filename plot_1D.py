...
def depth_timeseries(ds, names, levs, colors, vert_axes, limits, fname, integrate=False, offset=0):
    ...
    for i, name in enumerate(names):
        ...
        axs[i].set_xlim(datetime(2014, 1, 1), datetime(2034, 12, 31)) # ADDED - 2014 to 2034
        ...
        axs[i].axvline(np.datetime64("2015"), color="red", linestyle="--", linewidth=1)
        axs[i].axvline(np.datetime64("2024"), color="red", linestyle="--", linewidth=1)
